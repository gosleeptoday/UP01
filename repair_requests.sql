...
/****** Object:  Database [repair_requests]    Script Date: 18.12.2024 20:11:34 ******/
CREATE DATABASE [repair_requests]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'repair_requests', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\repair_requests.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'repair_requests_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\repair_requests_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [repair_requests] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
...
ALTER DATABASE [repair_requests] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
